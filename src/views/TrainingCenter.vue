              ...
              <div class="program-container">
                  <div class="program-row">
                      ...
                      <div class="program-content">
                          <div id="accreditation" class="widget-text pt-4">
                          ...
                          <div class="tc-container mb-90">
                              <div class="row">
                                  <div class="col-lg-4" v-for="(tc, index) in tcs"  :key="index">
                                    <div class="tc-box">
                                        <img :src="tc.img" class="img-fluid tc-img" :alt="tc.title" />
                                        <div class="program-title tc-title">
                                            {{ tc.title }}
                                        </div>
...
export default {
  ...
  data() {
    return {
      tcs: [
        {img: require('../assets/img/tie.jpg'), title: 'Training Center', text: 'AIPS Accreditation is an assurance of quality in professional studies in journalism and'},
        {img: require('../assets/img/tie.jpg'), title: 'Training Center', text: 'AIPS Accreditation is an assurance of quality in professional studies in journalism and'},
        {img: require('../assets/img/tie.jpg'), title: 'Training Center', text: 'AIPS Accreditation is an assurance of quality in professional studies in journalism and'},
      ]
    }
