          ...
          <div class="program-row">
            ...
            <div class="program-content">
              ...
              <div class="program-sectors">
                <div class="sectors-title">Explore AIPS Sectors</div>
                <!-- dynamic Only -->
                <div class="row">
                ...
                <div class="program-certification-widget">
                  ...
                  <div
                    class="program-certification-view"
                    :style="{backgroundImage:`url(${require('../assets/img/certification.jpg')}) !important`} "
                  ></div>
                </div>
              </div>
            </div>
